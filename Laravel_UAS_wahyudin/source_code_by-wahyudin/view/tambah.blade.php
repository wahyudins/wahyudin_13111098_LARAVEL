	...
	<div class="row" style="font-size: 20px">
		<div class="col-md-12">
				<ul class="nav navbar-nav" style="color: #1a237e">
					...
					<li class="active" style="background-color: #424242">
						<a href="#">&nbsp;menu 1&nbsp;</a>
					</li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<li class="">
						<a href="#">&nbsp;menu 2&nbsp;</a>
		...
		<div class="col-md-4">
			...
			<form action="{{ route('tambah')}}" method="post"> 
					<div class="form-group">
						<label>Nama</label>
						<input maxlength="18" type="text" style="height: 30px; width: 200px;" class="form-control" name="nama">
					</div>
					<div class="form-group">
						<label>NIM</label>
					...
					<input type="submit" style="color: #000000" class="btn btn-primary" name="submit" value="tambah">
					{{ csrf_field() }}
			</form>
		</div>
		<div class="col-md-4">
